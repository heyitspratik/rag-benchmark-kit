...
migration command works against a laptop, a compose stack and CI without a committed
connection string.
"""
...
def _database_url() -> str:
    """The URL to migrate, preferring an explicit -x url=... override."""
    override = context.get_x_argument(as_dictionary=True).get("url")
    return override or get_settings().db.dsn
